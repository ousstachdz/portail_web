class Form2 extends Component {
  ...
  static template = xml`
      <div>
        <h5 for="apropos" style="font-size: 16px; font-weight:bold; color: #F2643B;">
        ...
        <h5 for="gestion" style="font-size: 16px; font-weight:bold; color: #F2643B;">
          فريق التسيير
        </h5>
        <div class="text-end mb-3">
        ...
        <h5 for="tailles" style="font-size: 16px; font-weight:bold; color: #F2643B;">
